# Revision 47 — July 10, 2026

Safe to update from Rev 44+. Go to the Collections tab → Update. Say YES to
removing old mods. On load, ignore the missing-plugins warning and continue.

New here? [Download](#) · [Install issues](#) · [Discord](#)

> **Headline this update:** the Night City Interactions overhaul — Core plus all
> three addons jumped a full version, adding new interactable spots across the map.

Thanks to **Pigeon** and **Hex** for testing and conflict-patching this round.
...
- [Immersive Rippers 2.4.0](https://www.nexusmods.com/cyberpunk2077/mods/7064)
  - **Pack change:** disabled the aggressive-pricing option to match the pack economy
...
### Utility
_Framework bumps — nothing player-facing._
...
_Nothing removed this revision._
