...
- ~~weight encumbrance bug~~ **FIXED** by q new mod
- ~~bullet reflection too strong damage wise~~ on list for q
- ~~dual take down in the rescue triggers combat~~ **FIXED** by q in MBAI update
- ~~vehicle driving combat too much damage taken in~~ **FIXED** by q in MBAI update long as that also works with immersive shooting ai
- ~~noise of some cyber enemy abilities far too loud~~ had adjusted the volume down quite a bit in config file
- ~~is balls to the wall netrunner an issue? test~~ worked without issue
...
firestarter~~ on q's list for later
- ~~anvil os issue~~ on q's list for later 
