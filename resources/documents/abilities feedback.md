...
```
When hit within melee distance of player, releases toxic cloud, that poisons / hurt player. When killed 5% chance of releasing it too. When not killed, getting closed to their body will release cloud too. Setting them on fire, shortly after they have activated their ability, makes them explode, and pernamently turns off their ability
```
